...
// ╔════════════════════════════════════════ TYPE ════════════════════════════════════════╗
    ...
    export abstract class Component<P = Record<string, unknown>, S = Record<string, unknown>> {
        ...
        private _updateInProgress: boolean = false; // NEW: Prevent concurrent updates
        ...
        // ═══════════════════════════════════════════════════════════════════
        // COMPONENT MOUNT PRESERVATION (Critical for nested components)
        // ═══════════════════════════════════════════════════════════════════
